        ...
        <div className={styles.formWrapper}>
          ...
          <div className="mt-4">
            <button
              ...
              className="flex items-center justify-center w-full p-2 text-white bg-red-600 rounded-md hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2"
            >
              <svg
